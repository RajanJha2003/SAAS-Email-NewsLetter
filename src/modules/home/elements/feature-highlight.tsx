  ...
  return (
    <div className='w-full md:flex items-center bg-[#9399F4] py-5 text-center md:py-0 md:text-left md:min-h-[55vh]   '>
        ...
        <div className='md:w-[50%]'>
            <h2 className='font-clashDisplay uppercase text-cyber-ink text-3xl md:text-5xl mx-auto mb-2 font-semibold'>CREATE</h2>
            <br />
            <h3 className='text-cyber-ink text-xl md:text-3xl max-w-lg font-semibold'>The most powerful editing and design tools in email.</h3>
            <br />
